...
namespace FunctionApp9
{
    ...
    public static class Function1
    {
        ...
        [FunctionName("FacesDontLie")]
        public static async Task<IActionResult> FacesDontLie([HttpTrigger(AuthorizationLevel.Function, "get", "post", 
            Route = null)]HttpRequest req, TraceWriter log)
        {
            log.Info("Fabian Faces API call is about to be made...");
